...
CREATE TABLE `products` (
  ...
  `ProductShortDesc` varchar(500)  NULL,
  `ProductLongDecs` text ,
  `ProductThumb` varchar(100)  NULL,
  `ProductImage` text ,
  `ProductCategoryID` int(11)  NULL,
  `ProductStock` float  NULL,
  `ProductLive` tinyint(1)  '0',
  `ProductUnlimited` tinyint(1)  '1',
...
('bd1e1a60-385f-4693-a121-920bd37bcc1e', '211321-1121B', 'sas sasa sas', 0, 1, 'wdwa dwdad', ' dwda ad dwa  dadwwad', ' dw aw wda awdawdawdwa', '', '', NULL, NULL, 0, 1, NULL, '2019-05-13 13:40:42', '2019-05-13 13:40:42', '', ''),
